// navigation/challenges/gestureChallenges/page.js
import Link from "next/link";

export default function GestureChallengesOverviewPage() {
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 flex items-center justify-center p-4">
      <div className="bg-gray-800 p-8 rounded-lg shadow-xl text-center flex flex-col gap-6 items-center w-full max-w-md mx-auto">
        ...
        <p className="text-lg text-gray-300">
          Choose your challenge mode for Gesture.
        </p>
        <Link 
          href="/navigation/challenges/gestureChallenges/free" 
        ...
        <Link 
          href="/navigation/challenges/gestureChallenges/timed" 
